...
func TestNewResolverMetrics(t *testing.T) {
	...
	assert.Contains(t, names, "kubernetes_graphql_gateway_kubernetes_api_requests_total")
	assert.Contains(t, names, "kubernetes_graphql_gateway_kubernetes_api_request_duration_seconds")
